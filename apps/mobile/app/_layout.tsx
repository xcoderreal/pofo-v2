...
export default function RootLayout() {
  ...
  // Above the navigator, because a Grid cell tap selects a scope and then
  // shows the Portfolio tab at it — one view state, two destinations
  // reading it (behaviour.md § Grid).
        ...
        <QueryClientProvider client={queryClient}>
          ...
          >
            <Tabs.Screen
              ...
              options={{
                title: "Portfolio",
                tabBarButtonTestID: "nav-portfolio",
              }}
            />
            <Tabs.Screen
              name="grid"
